    ...
    try {
        switch (name) {
            ...
            case 'compare_runs': {
                ...
                const run1 = args?.run1;
                const run2 = args?.run2;
                if (!run1 || !run2) {
